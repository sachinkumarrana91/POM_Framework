...
public static String captureScreenshot(WebDriver driver, String result) throws IOException{
		...
		Calendar cal = new GregorianCalendar();
		  ...
		  String ImageDest = "C:\\Selenium_3rd_Tools\\apache-tomcat-9.0.0.M13\\webapps\\ROOT\\screenshots\\";
		  imageName = ""+year+""+month+""+date+""+day+""+min+""+sec+"";
		  
		  File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE); 
		  FileUtils.copyFile(scrFile, new File(ImageDest+imageName+ ".jpeg"));
